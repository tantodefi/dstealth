...
export async function GET(
  ...
  console.log('🚀 Convos lookup route called at:', new Date().toISOString());
  ...
  try {
    ...
    console.log(`⏱️  Making request to: ${backendUrl}/api/convos/lookup/${username}`);
    ...
    const duration = Date.now() - startTime;
    console.error(`💥 Error in convos lookup after ${duration}ms:`, error);
